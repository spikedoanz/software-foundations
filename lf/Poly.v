...
(** Which of the following are well-typed elements of [grumble X] for
    some type [X]?  (Add YES or NO to each line.)
      ...
      - [e bool true] YES
      - [e mumble (b c 0)] YES
      - [e bool (b c 0)] NO -- (b c 0) is not a term of type bool.
      - [c]   NO -- doesn't start with e or d
*)
(* FILL IN HERE *)
End MumbleGrumble.
(** [] *)
...
Proof.
  ...
  induction l as [|h t H].
  - simpl. reflexivity.
  - simpl. rewrite map_app_distr. rewrite H. simpl. reflexivity.
Qed.
...
Theorem fold_map_correct : 
  forall X (l : list X ), forall Y (f : X -> Y),
...
Check (fun (n: cnat) (X : Type) (f : X -> X) (x : X) => n X).


Definition church_num_id (n : cnat) : cnat :=
